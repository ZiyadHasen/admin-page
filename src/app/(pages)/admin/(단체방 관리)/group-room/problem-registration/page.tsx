...
import row4Column5 from "@/data/tables/column3/row4column5";
...
const ProblemRegistrationPage = () => {
  ...
  const pages = Math.ceil(row4Column5.length / rowsPerPage);
  ...
  const items = React.useMemo(() => {
    ...
    setCurrentData(row4Column5.slice(start, end));
    return row4Column5.slice(start, end);
  }, [page, row4Column5, 5, rowsPerPage]);
        ...
        <article>
          ...
          >
            <TableHeader className="th-border-1">
              ...
              <TableColumn>문제 등록</TableColumn>
              <TableColumn>경유지 순번</TableColumn>
